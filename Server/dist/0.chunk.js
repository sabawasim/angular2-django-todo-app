...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__all_tasks_routing__ = __webpack_require__(600);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__all_tasks_component__ = __webpack_require__(599);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_forms__ = __webpack_require__(238);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jquery__ = __webpack_require__(240);
...
var AllTasksComponent = (function () {
    function AllTasksComponent(http, router) {
        this.http = http;
        this.router = router;
        this.my_tasks = false;
    ...
    AllTasksComponent.prototype.deleteTask = function (id) {
        var _this = this;
        this.http.post('http://localhost:8000/todo_app/delete-task/', { id: id }, { headers: this.header }).map(function (res) {
            return res;
    ...
    AllTasksComponent.prototype.sumbitNewTask = function (name, description, status, assigned_to) {
        ...
        if (name.trim().length > 0 && description.trim().length > 0) {
            ...
            this.http.post('http://localhost:8000/todo_app/add-task/', data_obj, { headers: this.header }).map(function (res) {
                return res;
            }).subscribe(function (res) {
                if (res['success']) {
                    _this.allTasks();
    ...
    AllTasksComponent.prototype.allTasks = function () {
        var _this = this;
        this.http.get('http://localhost:8000/todo_app/view-all/', { headers: this.header }).map(function (res) {
            return res;
        }).subscribe(function (res) {
            _this.all_tasks = res;
        });
    ...
    AllTasksComponent.prototype.allUsers = function () {
        var _this = this;
        this.http.get('http://localhost:8000/user_management/view-all/', { headers: this.header }).map(function (res) {
            return res;
        }).subscribe(function (res) {
            _this.users = res;
        });
    ...
    AllTasksComponent.prototype.selectTask = function () {
        ...
        this.done_task = false;
        if (this.my_tasks) {
            this.http.post('http://localhost:8000/todo_app/view-my-task/', { id: this.login_data.id }, { headers: this.header }).map(function (res) {
                return res;
            }).subscribe(function (res) {
    ...
    AllTasksComponent.prototype.doneTask = function () {
        ...
        this.my_tasks = false;
        if (this.done_task) {
            this.http.post('http://localhost:8000/todo_app/hide-all-done-task/', {}, { headers: this.header }).map(function (res) {
                return res;
            }).subscribe(function (res) {
                if (res['tasks']) {
                    _this.all_tasks = res['tasks'];
    ...
    AllTasksComponent.prototype.submitEditTask = function (name, description, status, assigned_to) {
        ...
        if (name.trim().length > 0 && description.trim().length > 0) {
            ...
            this.http.post('http://localhost:8000/todo_app/edit-task/', data_obj, { headers: this.header }).map(function (res) {
                return res;
            }).subscribe(function (res) {
                if (res['success']) {
                    _this.allTasks();
    ...
    AllTasksComponent.prototype.updateTask = function (task) {
        var _this = this;
        this.http.post('http://localhost:8000/todo_app/markdone-task/', { id: task.id }, { headers: this.header }).map(function (res) {
            return res;
        }).subscribe(function (res) {
            if (res['success']) {
                _this.allTasks();
    ...
    AllTasksComponent.prototype.logout = function () {
        this.http.get('http://localhost:8000/user_management/logout/', { headers: this.header }).map(function (res) {
            return res;
        }).subscribe(function (res) {
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__all_tasks_component__ = __webpack_require__(599);
