...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.submitUser = function (user, pass) {
        var _this = this;
        this.register_result = false;
        return this.http.post('http://localhost:8000/user_management/login/', { 'username': user, 'password': pass }).subscribe(function (res) {
            if (!res.success) {
    ...
    HomeComponent.prototype.registerUser = function (user, pass, email, dept, desig) {
        var _this = this;
        return this.http.post('http://localhost:8000/user_management/create-user/', { 'username': user, 'password': pass, 'email': email, 'department': dept, 'designation': desig }).subscribe(function (res) {
            if (res.success) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_http__ = __webpack_require__(239);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__navbar_navbar_component__ = __webpack_require__(248);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__home_home_component__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__footer_footer_component__ = __webpack_require__(247);
